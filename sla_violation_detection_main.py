...
def prepareData(filename):
    ...
    dataSetFileName = path + "/input/jobs/" + filename + "small_8_features_remove_max_keep_avg.xlsx"
...
def plot_ROC(seqOfRun, imbalanceTechnique, featureTrans, featureSelection, clfName, tag, Y_true, Y_pred_result,
    ...
    auc_value = roc_auc_score(Y_true, Y_pred_result)
    roc_auc = auc(fpr, tpr)
...
def plotPRcurve(seqOfRun, imbalanceTechnique, featureTrans, featureSelection, clfName, y_one_hot, y_score, tag):
    ...
    print('auc=%.3f ap=%.3f' % (auc_value, ap))
...
clfMethod = ["OneVsRestXGB","OneVsRestRF","zeroRule","baggingXGB",'guess2', "SVC", "GradientBoostingClassifier", "best", "guess", "OneVsRestLR",
             "KerasNN", "PureRF", "OneVsRestRFClassWeight5", "OneVsRestRFClassWeight10",
...
if __name__ == '__main__':
    ...
    for resampling in resampingMethod[0:10]:
